...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, readBody, createError, sendError, getResponseStatusText } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/h3/dist/index.mjs';
import { PrismaClient } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/@prisma/client/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/xampp/htdocs/docker/youtube/base/front/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "apikey": "AIzaSyBiI4h4lJpIZ5od0YIrAOQWiTUDnA0Q0zs"
  }
};
...
const serverAssets = [{"baseName":"server","dir":"C:/xampp/htdocs/docker/youtube/base/front/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\xampp\\htdocs\\docker\\youtube\\base\\front","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\xampp\\htdocs\\docker\\youtube\\base\\front\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\xampp\\htdocs\\docker\\youtube\\base\\front\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\xampp\\htdocs\\docker\\youtube\\base\\front\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\xampp\\htdocs\\docker\\youtube\\base\\front\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _Vwv8psDnfD = (function(nitro) {
...
const _lazy_dPULRO = () => Promise.resolve().then(function () { return db_delete$1; });
const _lazy_R3N7vK = () => Promise.resolve().then(function () { return db_get$1; });
const _lazy_xnFTyT = () => Promise.resolve().then(function () { return db_post$1; });
const _lazy_e3xO2K = () => Promise.resolve().then(function () { return db_put$1; });
const _lazy_VB79lx = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/db', handler: _lazy_dPULRO, lazy: true, middleware: false, method: "delete" },
  { route: '/api/db', handler: _lazy_R3N7vK, lazy: true, middleware: false, method: "get" },
  { route: '/api/db', handler: _lazy_xnFTyT, lazy: true, middleware: false, method: "post" },
  { route: '/api/db', handler: _lazy_e3xO2K, lazy: true, middleware: false, method: "put" },
  { route: '/__nuxt_error', handler: _lazy_VB79lx, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_VB79lx, lazy: true, middleware: false, method: undefined }
];
...
const db_delete = defineEventHandler(async (e) => {
...
const db_delete$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: db_delete
});

const db_get = defineEventHandler(async (e) => {
  const prisma = new PrismaClient();
  const query = getQuery$1(e);
  let db = null;
  switch (query.table) {
...
const db_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: db_get
});

const db_post = defineEventHandler(async (e) => {
  const prisma = new PrismaClient();
  const query = getQuery$1(e);
  const body = await readBody(e);
  let output = null;
...
const db_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: db_post
});

const db_put = defineEventHandler(async (e) => {
  const prisma = new PrismaClient();
  const query = getQuery$1(e);
  const body = await readBody(e);
  let output = null;
...
const db_put$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: db_put
});
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"hid":"robots","name":"robots","content":"noindex"},{"name":"SKYPE_TOOLBAR","content":"SKYPE_TOOLBAR_PARSER_COMPATIBLE"},{"http-equiv":"X-UA-Compatibl","content":"IE=edg"},{"property":"og:type","content":"website"},{"property":"og:locale","content":"ja_JP"},{"property":"og:title","content":"Log."},{"property":"og:description","content":"Channel Manager"},{"property":"og:url","content":"https://xxx.xxx.xxx/"},{"property":"og:site_name","content":"Channel Manager"},{"property":"og:image","content":"/ogp.jpg"},{"name":"thumbnail","content":"/thumnail.png"}],"link":[{"rel":"shortcut icon","href":"/favicon.ico"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded:opsz,wght,FILL,GRAD@24,300,1,0"},{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;600&family=Roboto:wght@400;600&display=swap","crossorigin":""}],"style":[],"script":[],"noscript":[],"title":"Channel Manager","htmlAttrs":{"lang":"ja"}};
...
const getClientManifest = () => import('file://C:/xampp/htdocs/docker/youtube/base/front/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/xampp/htdocs/docker/youtube/base/front/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
